CONFIG_DESCRIPTIONS = [
    ...
    {name: 'menu_rocker_button', description: 'Mouse button while scrolling wheel', candidates: ['Left', 'Middle', 'Right']},
    {name: 'menu_modifier', description: 'Modifier key for bindings', candidates: ['Shift', 'Ctrl', 'Alt', 'Command', 'Meta']},
]

BINDING_DESCRIPTIONS = [
    {name: 'next_menu_tab', description: 'Next tab'},
    {name: 'prev_menu_tab', description: 'Prev tab'},
]
